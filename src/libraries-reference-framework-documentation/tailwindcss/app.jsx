...
export default function CustomApp() {
  return (
    <>
      ...
      <div className="after:content-['*'] text-[red]">CXhcocobar </div>

      <div class="snap-x flex overflow-x-auto">
      ...
      <div className='bg-backgroundImg1 h-96 border-border1 border-[5px] border-solid bg-cover bg-no-repeat bg-center'>Image 1</div>
      <div className='bg-backgroundImg2 h-96 border-border1 border-[5px] border-solid'>Image 2</div>
      <div className='bg-backgroundImg3 h-96 border-border1 border-[5px] border-solid'>Image 3</div>
      <div className='bg-backgroundImg4 h-96 border-border1 border-[5px] border-solid'>Image 4</div>
      <div className='bg-backgroundImg5 h-96 border-border1 border-[5px] border-solid'>Image 5</div>
      <div>
    ...
    "
      ...
      <ul role="list" className="p-6 divide-y divide-slate-200">
        ...
        <li className="flex py-4 first:pt-0 last:pb-0">
          <img className="h-10 w-10 rounded-full" src="https://tailwindcss.com/img/erin-lindford.jpg" alt="" />
